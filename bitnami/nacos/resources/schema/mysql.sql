...
CREATE TABLE IF NOT EXISTS `config_info` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `uk_configinfo_datagrouptenant` (`data_id`(128),`group_id`,`tenant_id`)
...
CREATE TABLE IF NOT EXISTS `config_info_aggr` (
    ...
    `tenant_id` varchar(128) DEFAULT '' COMMENT 'tenant',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uk_configinfoaggr_datagrouptenantdatum` (`data_id`(128),`group_id`,`tenant_id`,`datum_id`(128))
...
CREATE TABLE IF NOT EXISTS `config_info_beta` (
    ...
    `encrypted_data_key` varchar(1024) NOT NULL DEFAULT '' COMMENT 'key',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uk_configinfobeta_datagrouptenant` (`data_id`(128),`group_id`,`tenant_id`)
...
CREATE TABLE IF NOT EXISTS `config_info_tag` (
    ...
    `encrypted_data_key` varchar(1024) NOT NULL DEFAULT '' COMMENT 'key',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uk_configinfotag_datagrouptenanttag` (`data_id`(128),`group_id`,`tenant_id`,`tag_id`)
...
CREATE TABLE IF NOT EXISTS `config_info_gray` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `uk_configinfogray_datagrouptenantgray` (`data_id`(128),`group_id`,`tenant_id`,`gray_name`),
